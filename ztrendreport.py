...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,description='Prints a CSV trend report for daily max, min or average values for the specied item key.', epilog="""
